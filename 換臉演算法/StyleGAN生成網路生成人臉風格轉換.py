# -*- coding: utf-8 -*-
"""Untitled0612A5000.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ogc0Z06ugbr8d7XijI5ju_J3QWo03xB8
"""
...
train_selfie_path = '/content/drive/MyDrive/girl256'

train_selfie_imgs = np.array(sorted(os.listdir(train_selfie_path)))

train_selfie1_imgs = list(train_selfie_imgs[[0,80,100,170,210,235,330,390,420,450,510,528]])
train_selfie2_imgs = list(train_selfie_imgs[[52,90,155,180,220,245,290,350,410,440,470,508]])
...
generator = Generator()
generator.load_weights('/content/drive/MyDrive/Frank/generatorw0612B10000.h5')
generator.summary()
...
discriminator.load_weights('/content/drive/MyDrive/Frank/discriminatorw0612B10000.h5')
...
for epoch in range(EPOCHS):
    ...
    if epoch % 500 == 0:
      generator.save_weights("/content/drive/MyDrive/Frank/generatorw0612C20000.h5")
      discriminator.save_weights("/content/drive/MyDrive/Frank/discriminatorw0612C20000.h5")
